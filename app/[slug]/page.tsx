...
const CATEGORIES: { label: string; href: string }[] = [{"label":"🐕 Dog Food & Treats","href":"/category/dog-food"},{"label":"🐈 Cat Food & Treats","href":"/category/cat-food"},{"label":"🛁 Pet Grooming","href":"/category/pet-grooming"},{"label":"🏠 Dog Beds & Crates","href":"/category/dog-beds"},{"label":"😺 Cat Trees & Toys","href":"/category/cat-furniture"},{"label":"🦮 Leashes & Harnesses","href":"/category/leashes-harnesses"},{"label":"🩺 Pet Health","href":"/category/pet-health"},{"label":"📷 Pet Cameras & GPS","href":"/category/pet-tech"},{"label":"🐾 Litter & Cleanup","href":"/category/litter-cleanup"},{"label":"✈️ Pet Travel Gear","href":"/category/pet-travel"},{"label":"🐟 Small Pets & Fish","href":"/category/small-pets"},{"label":"🦴 Dental & Hygiene","href":"/category/pet-dental"}];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.description || "",
      type: "article",
      url: `https://www.pawrankings.com/${slug}`,
      siteName: "Paw Rankings",
    ...
    alternates: { canonical: `https://www.pawrankings.com/${slug}` },
  };
}
...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = JSON.stringify({
    ...
    url: `https://www.pawrankings.com/${slug}`,
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.pawrankings.com/${slug}` },
    author: { "@type": "Organization", name: "Paw Rankings", url: "https://www.pawrankings.com" },
    publisher: {
      "@type": "Organization",
      name: "Paw Rankings",
      url: "https://www.pawrankings.com",
      logo: { "@type": "ImageObject", url: "https://www.pawrankings.com/logo.png", width: 200, height: 60 }
    },
    keywords: post.keyword || "",
  });
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.pawrankings.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.pawrankings.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.pawrankings.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#0d0806;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#f97316;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">Paw Rankings Editorial Team</div>
