    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(245,158,11,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(249,115,22,0.12) 0%, transparent 60%); pointer-events: none; }
      ...
      <section className="hero">
        ...
        <div className="hero-badge">Tested by Pet Lovers</div>
        <h1 dangerouslySetInnerHTML={{ __html: "The Best Products<br />for Your Furry Family" }} />
        <p>Trusted rankings of pet food, beds, toys and health products for dogs, cats and small animals. Because your pet deserves the very best — and you deserve the truth.</p>
        <div className="hero-ctas">
          <a href="/best-pet-products" className="hero-cta-primary">Find Top Pet Products →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"400+","l":"Products Ranked"},{"v":"50+","l":"Expert Reviews"},{"v":"70K+","l":"Pet Parents"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"Best Dog Food 2025","hot":true,"href":"/best-dog-food"},{"label":"Grain-Free vs Grain","hot":true,"href":"/grain-free-vs-grain-dog-food"},{"label":"Best Cat Food","href":"/best-cat-food"},{"label":"Interactive Dog Toys","hot":true,"href":"/best-interactive-dog-toys"},{"label":"Orthopedic Dog Beds","href":"/best-orthopedic-dog-beds"},{"label":"Flea Treatment Guide","href":"/best-flea-treatment"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Top Pet Products of 2025</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"Best Dog Food","badgeType":"gold","icon":"🐶","title":"Ollie Fresh Dog Food","desc":"Human-grade ingredients, vet-formulated recipes, delivered fresh to your door weekly.","rating":5,"href":"/ollie-dog-food-review"},{"badge":"Best Cat Food","badgeType":"silver","icon":"🐱","title":"Smalls Human Grade Cat","desc":"Real meat, no fillers, no rendered ingredients. Cats love it and vets approve it.","rating":5,"href":"/smalls-cat-food-review"},{"badge":"Best Toy","badgeType":"bronze","icon":"🎾","title":"KONG Classic","desc":"The original enrichment toy — stuffable, dishwasher safe and virtually indestructible.","rating":5,"href":"/kong-classic-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Rank Pet Products</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"Vet-Guided Research","desc":"Every food review references AAFCO standards, ingredient quality and veterinary nutritionist input."},{"num":"02","title":"Real Pet Testing","desc":"Products are tested by our team's pets and a panel of 50+ pet owners across different breeds and ages."},{"num":"03","title":"You Choose with Confidence","desc":"Our rankings cut through marketing claims and help you find what actually keeps your pet healthy and happy."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🐶","label":"Dog Food","desc":"Dry, wet & raw diets compared","href":"/category/dog-food"},{"icon":"🐱","label":"Cat Food","desc":"Kibble, wet food & raw meals","href":"/category/cat-food"},{"icon":"🛏️","label":"Pet Beds","desc":"Orthopedic, cozy & heated beds","href":"/category/pet-beds"},{"icon":"🎾","label":"Toys","desc":"Interactive & durable toys","href":"/category/pet-toys"},{"icon":"✂️","label":"Grooming","desc":"Brushes, shampoos & tools","href":"/category/grooming"},{"icon":"💊","label":"Pet Health","desc":"Supplements, flea & wellness","href":"/category/pet-health"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust Paw Rankings</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"🐾","title":"Pet Owners Review","desc":"Our team has dogs, cats and small animals — these products are tested on our own beloved pets first."},{"icon":"👨‍⚕️","title":"Vet-Reviewed Content","desc":"All food and health recommendations are reviewed by licensed veterinarians before publication."},{"icon":"🔍","title":"Ingredient Transparency","desc":"We read every ingredient label and check recall histories before making any recommendation."},{"icon":"💚","title":"Animal Welfare Focus","desc":"We only recommend brands that meet our ethical sourcing and animal welfare standards."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"What is the healthiest dog food in 2025?","a":"Fresh dog food services like Ollie and The Farmer's Dog rank highest for ingredient quality. For kibble, we recommend Orijen and Acana as the top premium options."},{"q":"Is grain-free dog food safe?","a":"The FDA investigated a potential link between grain-free diets and DCM in dogs. Current evidence is inconclusive, but we recommend rotating proteins and consulting your vet."},{"q":"How often should I replace my dog's bed?","a":"Most quality dog beds last 2-3 years with regular washing. Signs it's time to replace: flattened padding, torn cover, or your dog avoiding it."},{"q":"What is the best toy for an aggressive chewer?","a":"KONG Classic (rubber), West Paw Zogoflex and Goughnuts rings are specifically designed for power chewers and have excellent safety records."},{"q":"How do I choose between wet and dry cat food?","a":"Cats benefit from moisture in their diet, so a combination of wet and dry food is ideal. We recommend at least 50% wet food for optimal kidney health."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="cta-section">
          <h2>Give Your Pet the Life They Deserve</h2>
          <p>Honest rankings and expert reviews to help you choose what actually keeps your pet healthy and happy.</p>
          <a href="/best-pet-products" className="cta-btn">Browse All Rankings →</a>
        </div>
