...
export const metadata: Metadata = {
  title: "Best Pet Products Ranked 2025 — Paw Rankings",
  description: "Expert-reviewed rankings of pet food, beds, toys and health products for dogs, cats and small animals. Your pet deserves the best.",
};
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --accent: #f59e0b; --accent2: #f97316; --radius: 12px;
        }
        body { background: var(--bg); color: var(--text); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; line-height: 1.6; }
        a { text-decoration: none; color: inherit; }
        .container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }
        .hero { position: relative; overflow: hidden; padding: 90px 24px 80px; text-align: center; }
        .hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(245,158,11,0.15) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(249,115,22,0.1) 0%, transparent 60%); pointer-events: none; }
        .hero-badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; border-radius: 20px; background: rgba(245,158,11,0.1); border: 1px solid rgba(245,158,11,0.25); color: var(--accent); font-size: 0.8rem; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 24px; }
        ...
        .hero-cta { display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px; border-radius: 50px; background: linear-gradient(135deg, var(--accent), var(--accent2)); color: #fff; font-weight: 700; font-size: 1rem; transition: opacity 0.2s, transform 0.2s; box-shadow: 0 0 30px rgba(245,158,11,0.3); }
        ...
        .category-card:hover { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(245,158,11,0.1); }
        ...
        .featured-visual { display: flex; align-items: center; justify-content: center; min-height: 280px; font-size: 5rem; background: linear-gradient(135deg, rgba(245,158,11,0.12), rgba(249,115,22,0.08)); }
        .featured-content { padding: 40px 36px; display: flex; flex-direction: column; justify-content: center; gap: 0; }
        .featured-badge { display: inline-block; padding: 4px 12px; border-radius: 20px; background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.25); color: var(--accent); font-size: 0.72rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 16px; width: fit-content; }
        ...
        .post-tag { display: inline-block; padding: 3px 10px; border-radius: 20px; background: rgba(249,115,22,0.1); border: 1px solid rgba(249,115,22,0.2); color: var(--accent2); font-size: 0.7rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; margin-bottom: 12px; }
        ...
        .cta-section { margin: 20px 0 60px; padding: 60px 40px; background: linear-gradient(135deg, var(--surface), rgba(245,158,11,0.06)); border: 1px solid var(--border); border-radius: var(--radius); text-align: center; }
...
`}</style>
      ...
      <section className="hero">
        ...
        <p>Trusted rankings of pet food, beds, toys and health products for dogs, cats and small animals. Because your pet deserves the very best.</p>
        <a href="/best-pet-products" className="hero-cta">Find Top Pet Products →</a>
        <div className="stats-bar">
          {([{"v":"400+","l":"Products Ranked"},{"v":"50+","l":"Expert Reviews"},{"v":"70K+","l":"Pet Parents"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((s) => (
      ...
      <div className="container">
        ...
        <div className="cta-section">
          ...
          <p>Get honest rankings and expert reviews to give your pet the happy, healthy life they deserve.</p>
