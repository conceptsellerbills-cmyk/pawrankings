...
export const metadata: Metadata = { title: "Cookie Policy — Paw Rankings", description: "Cookie Policy for Paw Rankings (pawrankings.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@pawrankings.com">hello@pawrankings.com</a>.</p>
      </div>
    </>
  );
}
