...
export const metadata: Metadata = { title: "Contact — Paw Rankings", description: "Get in touch with the Paw Rankings team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@pawrankings.com">hello@pawrankings.com</a>. We reply within 1–2 business days.</p>
        </div>
