...
export const metadata: Metadata = { title: "Advertise — Paw Rankings", description: "Advertise with Paw Rankings and reach a targeted audience interested in pet products and care." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on Paw Rankings</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing pet products and care. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@pawrankings.com">hello@pawrankings.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
