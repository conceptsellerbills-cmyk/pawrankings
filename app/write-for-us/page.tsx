...
export const metadata: Metadata = { title: "Write for Us — Paw Rankings", description: "Contribute a guest post to Paw Rankings. Share your expertise on pet products and care." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know pet products and care well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on pet products and care</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@pawrankings.com">hello@pawrankings.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
