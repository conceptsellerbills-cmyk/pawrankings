...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/pawrankings");
    script.setAttribute("data-repo-id", "R_kgDOR9HKUA");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR9HKUM4C6gbl");
